...
- **공식 웹사이트 및 문서**: [H2 Database Engine](https://www.h2database.co/)
- **GitHub 저장소**: [h2database/h2database](https://github.com/h2database/h2databae)
- **IntelliJ IDEA 연동 가이드**: [H2 | IntelliJ IDEA Documentation](https://www.jetbrains.com/help/idea/h2.htl)

---

## 🐬 MySQL

- **공식 문서**: [MySQL Documentation](https://dev.mysql.com/dc/)
